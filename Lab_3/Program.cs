    ...
    static void AddPlayer()
    {
        ...
        while (true)
        {
            ...
            static void PrintPlayers()
            {
                ...
                {
                    Console.WriteLine($"{i + 1}. {players[i].Name}, Вік: {players[i].Age},  {players[i].PlayerPosition}, Зріст: {players[i].Height} см, Вага: {players[i].Weight} кг, Стан травмованості: {players[i].IsInjured}, Номер футболки: {players[i].ShirtNumber} ");
                }
            }
